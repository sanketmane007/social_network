				...
				<?php
					$sel_msg = "select * from user_messages where (user_to='$user_to_msg'
					 ...
					 user_to='$user_from_msg') ORDER by 1 ASC";
						...
						<p><?php if($user_to == $user_to_msg AND $user_from ==
                         $user_from_msg)
						 {echo
						 "<div class='message' id='blue' date-toggle
						 ='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";
						 }
						 else if($user_from == $user_to_msg AND $user_to ==
						 $user_from_msg)
						 {echo" <div class='message' id='green' date-toggle
						 ='tooltip' title='$msg_date'>$msg_body</div><br><br>";
						 } ?></p>
						</div>
						<?php
						...
						<?php    
							if(isset($_GET['u_id']))
							{
								...
								if($u_id == "new")
								{
									...
									your message" name="msg_box" id="message_textarea"></textarea>
						...
						<?php 
							if(isset($_POST['send_msg']))
							{
								...
								if($msg == "")
								{
									...
									{
										echo"<h4 style='color:red;text-align:center;'>
									message is too long! use only 37 characters!</h4>";
									}else
									{
					...
					<div class="col-sm-3">
						...
						else
						{
							...
							style='color:gray;'>$describe_user</strong></li>
