...
<div class="row">
	 ...
	 <center><h1 style="color:white;"><strong> coding cafe </strong>  </h1></center>
		...
		<input id="password" type="password" class="form-control" name="pass" placeholder="New password" required>
			...
			<div class="input-group">
			<span class="input-group-addon"><i class="glyphicon glyphicon-lock"> </i> </span>
			<input id="password" type="password" class="for-control" placeholder="Re-enter new password" name="pass1" required>
		</div> <br>
		...
		if($pass == $pass1)
		{
			if(strlen($pass) >=6 && strlen($pass) <= 60)
			{
				...
				echo"<script>alert('your password change a mement ago')  </script>";
			
				echo"<script> window.open('home.php','_self')</script>";
			}
			else
			{
				echo"<script>alert('your password should greater than 6 words')  </script>";
			}
		}
			else{
