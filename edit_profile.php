...
<div class="row">
	...
	<div class='col-sm-8'>
		...
		<tr>
			<td style="font-weight:hold;">change your Lastname</td>
			<td><input class="form-control" type="text" name="l_name" required value="<?php echo $last_name; ?>">
			</td>
		</tr>
		
		<tr>
			<td style="font-weight:hold;">change your Username</td>
		...
		<tr>
			<td style="font-weight:hold;">Password</td>
		...
		<tr>
			<td style="font-weight:hold;">Email</td>
			<td><input class="form-control" type="text" name="u_email" required value="<?php echo $user_email; ?>">
			</td>
		</tr>
		...
		<tr>
		 ...
		 <tr>
			<td style="font-weight:hold;">Birthdate</td>
		...
		<tr>
			...
			<textarea class="form-control" cols="83" rows="83" rows="4" name="content" placeholder="Someone"></textarea><br>
		...
		if($bfn == '')
		{
			echo"<script>alert('plz enter something')</script>";
