	...
	?>
			...
			if(isset($_GET['u_id']))
			{
				...
				echo"
					...
					<center>
					<div style='backgrount-color:#e6e6e6;' class='col-sm-3'>
				...
				";
					...
					$userown_id = $row['user_id'];
						...
						if($user_id == $userown_id)
						{
							...
							btn-success'/>Edit_Profile</a><br><br><br>";
						}
					echo"
					</div>
					</center>
			...
			if(isset($_GET['u_id']))
			{
				...
				while($row_posts = mysqli_fetch_array($run_posts))
				{
					...
					echo"
						...
						<h4><small style='color:black;'>Updated
bng						a post on><strong>$post_date</strong></small></h4>
